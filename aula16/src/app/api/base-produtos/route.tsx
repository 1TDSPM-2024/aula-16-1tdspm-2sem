...
export async function POST(request:Request) {
    ...
    //Transformando a lista em JSON/string para depois colocar de volta no arquivo:
    const fileJson =  JSON.stringify(produtos);

    //Agora devolvemos a lista de produtos no arquivo sobrepondo os dados antigo pelos novos:
